...
parser.add_argument('--data-logfile',type=str,help="Path to logfile if logging is on")
parser.add_argument('--cpu-mode',type=bool,default=False,help="CPU or Cuda mode")
...
parser.add_argument('--use-states', default=(6), type=str,
